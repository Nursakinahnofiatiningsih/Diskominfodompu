...
$ambildata=mysql_query("SELECT * FROM berita WHERE id");
...
<!-- <meta property yang baru>-->
<meta property="og:title" content="<?php echo $data['judul']; ?>"/>
<meta property="og:description" content="Selamat Datang di Web Portal Resmi <?php echo $tiden['nama_pemilik']; ?>. Web ini menyediakan segala informasi mengenai <?php echo $tiden['nama_pemilik']; ?>. Informasi pemerintahan, informasi desa dan berita." />
<meta property="og:url" content="<?php echo $tiden['alamat_website']; ?>"/>
<meta property="og:image" content="<?php echo $data['gambar']; ?>"/>
		...
		<div class="container">
			<div class="row">
				<div class="col-xs-12 text-center">
					...
					Copyright &copy; 2017 Website Resmi <?php echo $tiden['nama_pemilik']; ?> All Right Reserved. Powered by <a target="_blank" href="http://selongweb.com"> SelongWeb.Com </a>
					</p>
